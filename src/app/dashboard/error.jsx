...
export default function DashboardError({ error, reset }) {
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#0D0D0D] to-[#1A1A1A] text-white pt-20 flex items-center justify-center">
      <div className="text-center space-y-6 px-6 max-w-md">
        <AlertCircle className="w-20 h-20 mx-auto text-red-600" />
        <h1 className="text-4xl font-bold">Error Loading Dashboard</h1>
